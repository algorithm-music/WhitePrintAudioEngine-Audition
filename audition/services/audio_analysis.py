...
class ParamConstraint(typing.TypedDict):
    """A single parameter constraint generated by AI."""
    param_name: str
...
class GuardrailResponse(typing.TypedDict):
    """AI-generated guardrails based on measured signal characteristics."""
...
def analyze_audio_file(fp: str) -> Dict[str, Any]:
    ...
    # Ask Vertex AI to generate parameter constraints based on measured metrics
    guardrails = _generate_guardrails_via_vertex(metrics, problems)
